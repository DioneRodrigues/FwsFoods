...
CREATE TABLE "Restaurant" (
    ...
    "deliveryFre" DECIMAL(10,2) NOT NULL,
...
-- AddForeignKey
ALTER TABLE "Product" ADD CONSTRAINT "Product_restourantId_fkey" FOREIGN KEY ("restourantId") REFERENCES "Restaurant"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
